                        ...
                        <div className="col-lg-3 col-sm-12">
                            <ul class="list-group favourites-generes">
                            {
                                this.state.genres.map((genre)=>(
                                    ...
                                    <li class="list-group-item" style={{background:'#3f51b5',color:'black',fontWeight:'bold'}}>{genre}</li> :
                                    <li class="list-group-item" style={{background:'white',color:'black'}} onClick={()=>this.handleGenreChange(genre)}>{genre}</li>
